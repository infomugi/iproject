...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		<div class="row text-right">
			...
			<div class="col-xs-3">
				<strong>
					<?php echo Yii::app()->numberFormatter->format("Rp ###,###,###",($model->Project->amount * $model->percent / 100)); ?> <br>
					<?php echo Yii::app()->numberFormatter->format('Rp ###,###,###',($model->Project->amount * $model->percent / 100) / 100 * $model->discount); ?> ( <?php echo $model->discount; ?>% )
				</strong>
			</div>
		</div>
		<div class="row text-right">
			...
			<div class="col-xs-3">
				<strong>
					<?php echo Yii::app()->numberFormatter->format('Rp ###,###,###',($model->Project->amount * $model->percent / 100)- ((($model->Project->amount * $model->percent / 100) / 100) * $model->discount)); ?> <br>
				</strong>
			</div>
		</div>
		<br>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-xs-6 text-right">
					<small>Printed By : <?php echo Yii::app()->user->record->fullname;?>, Date : <?php echo date("d/m/Y"); ?></small></BR>
				</div>
